...
public final class DbConfig {
    ...
    public static DbConfig of(
            String id, String url, String user, String password, String driver, String validationSelect) { // NOPMD
     ...
     * {@code Connection#setReadOnly} call entirely — required for drivers that reject the call on server-side read-only
     * connections (e.g. ClickHouse with a read-only user profile).
     *
     * <p>For ClickHouse you typically don't need to call this directly: {@link DbAccessFactory#createNonTransactional}
     * already applies {@code null} internally.
     */
