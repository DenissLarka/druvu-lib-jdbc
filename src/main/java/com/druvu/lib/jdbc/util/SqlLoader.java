...
/** @author Deniss Larka on 03 May 2022 */
public final class SqlLoader {
    ...
    private static void inputStreamToBulkStrings(
            InputStream inputStream, Consumer<SqlStatement<Map<String, Object>>> consumer) {
