...
/**
 * Can be useful in @{@link com.druvu.lib.jdbc.SqlStatement#getParameters()} when you need to combine params from
 * different places. Also, to flat results if a mapper type is a collection. Generally this is an array merger
 *
