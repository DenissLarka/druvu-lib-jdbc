...
Write-Host "`nGitHub Actions will now build and publish." -ForegroundColor Cyan
Write-Host "Check progress at: https://github.com/DenissLarka/druvu-lib-jdbc/actions" -ForegroundColor Cyan
